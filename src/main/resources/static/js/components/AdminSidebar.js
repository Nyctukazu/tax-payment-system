class AdminSidebar extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            ...
            <aside class="sidebar-drawer" id="sidebarDrawer">
                <div class="sidebar-links-container">
                    ...
                    <a href="/logout" class="sidebar-item logout-accent">
        ...
        // Listen for the global click signal dispatched from AdminHeader.js
        window.addEventListener('toggle-admin-sidebar', toggleSidebar);
        
        // Close if clicking outside on the backdrop overlay
